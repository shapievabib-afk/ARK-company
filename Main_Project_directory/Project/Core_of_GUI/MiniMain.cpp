...
//Этот мейн по сути является тем, что будет в приложении выводить отпарсенные данные. Тобишь это не мейн самого приложения, его будет писать Андрей, наверное, это лишь мини мейн, вызываемый при работе с ком-портом. Можно будет потом назвать его как WindowData хз. Оставляю этот код на проработку Милане.
